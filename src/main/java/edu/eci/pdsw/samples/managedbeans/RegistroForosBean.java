...
public class RegistroForosBean implements Serializable{
    ...
    public void registraRespuesta() throws ExcepcionServiciosForos{
        ...
        sp.agregarRespuestaForo(ef.getIdentificador(), respuesta);
    ...
    public Set<Comentario> getRespuestas(){
        Set<Comentario> respuestas = ef.getRespuestas();
        return respuestas;
    }
